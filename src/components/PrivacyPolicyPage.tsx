  ...
  return (
    <div className="min-h-screen bg-transparent text-neutral-900 dark:text-white transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 lg:py-32">
        ...
        <LegalChapter number={1} subtitle="quién soy" title="Aviso Legal">
          <AvisoLegalContent />
        </LegalChapter>

        <LegalChapter number={2} subtitle="tus datos" title="Política de Privacidad">
          <PrivacidadContent />
        </LegalChapter>

        <LegalChapter number={3} subtitle="galletas digitales" title="Política de Cookies">
          <CookiesContent />
        </LegalChapter>

        <LegalChapter number={4} subtitle="tu dinero" title="Términos y Condiciones de Suscripción">
          <TerminosContent />
        </LegalChapter>
      </div>
    </div>
