...
export default function Hero() {
  ...
  return (
    <div className="bg-transparent relative overflow-hidden pb-4 lg:pb-8 pt-20 lg:pt-32 transition-colors duration-300">

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 lg:pt-16">
