...
export default function Hero() {
  return (
    <div className="bg-[#fdfcfb] dark:bg-[#1a1816] relative overflow-hidden pb-4 lg:pb-8 pt-6 lg:pt-20 transition-colors duration-300">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 pt-4 lg:pt-32">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-16 max-w-5xl lg:max-w-none mx-auto lg:mx-0">

          <div className="space-y-3 animate-fade-in w-full lg:w-auto">
            <h1 className="text-[2.5rem] sm:text-[3.2rem] lg:text-6xl xl:text-[4.5rem] 2xl:text-[5rem] font-bold text-neutral-900 dark:text-white leading-[1.1] sm:leading-[0.95] lg:leading-[0.9] tracking-[-0.03em] transition-colors text-left">
              Escribo emails y hay gente que paga por leerlos.
            </h1>

            <p className="text-[1.1rem] sm:text-[1.3rem] lg:text-[1.5rem] text-neutral-600 dark:text-white/70 font-normal transition-colors text-left">
              A ver, que la gente paga por cualquier cosa, tampoco te sorprendas.
            </p>
          </div>

          <div className="animate-fade-in-delayed flex flex-col items-center w-full lg:w-auto lg:flex-shrink-0">
            <div className="w-[75%] sm:w-[60%] lg:w-[380px] xl:w-[420px]">
              <img
                src={alvaroImage}
                alt="Álvaro Barra"
