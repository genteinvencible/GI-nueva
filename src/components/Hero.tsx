  ...
  return (
    <div className="bg-[#fdfcfb] dark:bg-[#1a1816] relative overflow-hidden pb-4 lg:pb-8 pt-6 lg:pt-20 transition-colors duration-300">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 pt-4 lg:pt-32">
        <div className="flex flex-col lg:flex-row justify-start items-center lg:items-start gap-8 lg:gap-16">

          <div className="space-y-3 animate-fade-in w-full lg:w-fit lg:max-w-max text-left">
          ...
          <div className="animate-fade-in-delayed flex flex-col items-center w-full lg:w-auto">
