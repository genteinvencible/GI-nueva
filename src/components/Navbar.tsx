  ...
  return (
    ...
    >
      ...
      <div className="relative w-[350px] md:w-[450px] mb-8">
        ...
        <div className="absolute top-1 left-1/2 -translate-x-1/2 w-[400px] h-32 bg-gradient-to-b from-amber-300/30 dark:from-amber-200/20 via-amber-200/15 dark:via-amber-100/12 to-transparent blur-2xl pointer-events-none" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[320px] h-24 bg-gradient-to-b from-amber-200/25 dark:from-amber-100/15 to-transparent blur-xl pointer-events-none" />
      </div>
