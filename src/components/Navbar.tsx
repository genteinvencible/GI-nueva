    ...
    >
      ...
      <nav className="flex items-center gap-1 relative">
        ...
        <div className="absolute inset-0 left-1/2 -translate-x-1/2 w-[100vw] h-full -z-10">
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-amber-200/8 dark:via-amber-200/5 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-amber-100/6 dark:via-amber-100/4 to-transparent blur-sm" />
        </div>
