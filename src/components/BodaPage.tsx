      ...
      <div className="bg-[#d8d4cb] dark:bg-[#2a2622] pt-32 lg:pt-40 pb-32 lg:pb-44 transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <RevealBlock
            ...
            delay={0.1}
          >
            Cómo casarte <span className="underline decoration-[0.12em] decoration-neutral-900/15 dark:decoration-white/20 underline-offset-[0.08em]">sin meter a nadie en un compromiso</span>, salvo a ti (así ha sido nuestra boda sobresfree)
          </RevealBlock>
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8 pb-20 lg:pb-32">
        <div className="space-y-5">
          <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.7] transition-colors">
            <span className="float-left text-[2.6rem] lg:text-[2.8rem] font-bold leading-[1] mr-2 mt-[0.15rem] text-neutral-800 dark:text-white">E</span>l 4 de septiembre de 2021, Carmen y yo nos casamos, pero <strong className="font-bold text-neutral-800 dark:text-white">no fue una boda "normal"</strong>.
          </RevealBlock>
