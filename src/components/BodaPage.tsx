    ...
    <div className="min-h-screen bg-transparent text-neutral-900 dark:text-white transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-24 lg:pt-36 pb-20 lg:pb-32">
        ...
        <div className="max-w-3xl">
          <RevealBlock
            as="h1"
            className="text-[1.75rem] lg:text-[2.25rem] text-neutral-800 dark:text-white leading-[1.15] font-bold transition-colors mb-10 lg:mb-14"
          >
            Cómo casarte sin meter a nadie en un compromiso, salvo a ti (así ha sido nuestra boda sobresfree)
          </RevealBlock>

          <div className="space-y-5">
            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.1}>
              El 4 de septiembre de 2021, Carmen y yo nos casamos, pero no fue una boda "normal".
            </RevealBlock>

            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.15}>
            ...
            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.2}>
              Lo que nosotros hicimos, bajo mi sesgada opinión, fue mejor.
            </RevealBlock>

            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.25}>
              Quiero y puedo.
            </RevealBlock>

            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.3}>
              A ver tú qué opinas.
            </RevealBlock>

            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.35}>
            ...
            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.4}>
            ...
            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.45}>
              Sí, nos ha costado, porque hemos pagado nosotros. Los invitados estaban, de verdad, invitados. El regalo era venir.
            </RevealBlock>

            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors font-bold" delay={0.5}>
              Sobresfree.
            </RevealBlock>

            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors" delay={0.55}>
          ...
          <div className="space-y-5">
            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors">
            ...
            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors font-bold">
          ...
          <div className="space-y-5">
            ...
            <RevealBlock as="p" className="text-[1.1rem] lg:text-[1.15rem] text-neutral-700 dark:text-neutral-200 leading-[1.6] transition-colors italic pl-4 border-l-2 border-neutral-300 dark:border-neutral-600">
